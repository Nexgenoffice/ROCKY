  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-4 right-4 md:top-6 md:right-8 group cursor-pointer"
      ...
      >
        ...
        >
          {nightMode ? (
            <svg className="w-6 h-6 md:w-8 md:h-8 text-yellow-300" fill="currentColor" viewBox="0 0 24 24">
      ...
      {nightMode && (
        <button
          ...
          className="fixed top-4 right-20 md:top-6 md:right-28 group cursor-pointer"
          style={{ zIndex: 60, pointerEvents: 'auto' }}
        >
          <div
            className={`w-12 h-12 md:w-16 md:h-16 rounded-full flex items-center justify-center transition-all duration-300 border-2 border-white/30 cursor-pointer ${
          ...
          >
            <svg className={`w-6 h-6 md:w-8 md:h-8 ${lightsOn ? 'text-white' : 'text-gray-400'}`} fill="currentColor" viewBox="0 0 24 24">
